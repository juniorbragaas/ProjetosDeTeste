CREATE TABLE Fatura (
    ...
    [numeroTentativasEnvio] INT             CONSTRAINT [numeroTentativasEnvioFDefault] DEFAULT ((0)) NULL,
	[dataEnvio]             DATETIME        NULL,
    [status]                VARCHAR (255)   NULL,
       numeroPreFatura  VARCHAR (255)   NULL,
dataPreFatura  DATETIME        NULL,
numeroFatura  VARCHAR (255)   NULL,
dataVencFatura  DATETIME        NULL,
dataFatura DATETIME        NULL,
CodTranspMatriz VARCHAR (255)   NULL,
codTranspEmit VARCHAR (255)   NULL,
numeroDocFiscal  INT             NULL,
serieDocFiscal  INT             NULL,
dataDocFiscal DATETIME        NULL,
chaveCTe  VARCHAR (255)   NULL,
docTransporte  VARCHAR (255)   NULL,
